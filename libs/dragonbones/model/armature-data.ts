...
import { ActionData, UserData } from './user-data';
...
import { MeshDisplayData, GeometryData } from './display-data';
...
export class ArmatureData extends BaseObject {
   ...
   * @private
   */
  public readonly bones: SMap<BoneData> = {};
  /**
   * @private
   */
  public readonly slots: SMap<SlotData> = {};
  /**
   * @private
   */
  public readonly constraints: SMap<ConstraintData> = {};
  /**
   * @private
   */
  public readonly skins: SMap<SkinData> = {};
  /**
   * @private
   */
  public readonly animations: SMap<AnimationData> = {};
  /**
  ...
  public sortBones(): void {
    ...
    while (count < total) {
      ...
      let flag = false;
      for (let k of Object.keys(this.constraints)) { // Wait constraint.
  ...
  protected _onClear(): void {
    ...
    for (let k of Object.keys(this.bones)) {
      this.bones[k].returnToPool();
      delete this.bones[k];
    }

    for (let k of Object.keys(this.slots)) {
    ...
    for (let k of Object.keys(this.skins)) {
