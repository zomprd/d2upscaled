...
export class AnimationData extends BaseObject {
   ...
   * @private
   */
  public readonly boneTimelines: SMap<Array<TimelineData>> = {};
  /**
   * @private
   */
  public readonly slotTimelines: SMap<Array<TimelineData>> = {};
  /**
   * @private
   */
  public readonly constraintTimelines: SMap<Array<TimelineData>> = {};
  /**
   * @private
   */
  public readonly animationTimelines: SMap<Array<TimelineData>> = {};
  /**
   * @private
   */
  public readonly boneCachedFrameIndices: SMap<Array<number>> = {};
  /**
   * @private
   */
  public readonly slotCachedFrameIndices: SMap<Array<number>> = {};
  /**
   * @private
   */
  ...
  protected _onClear(): void {
    for (let k of Object.keys(this.boneTimelines)) {
    ...
    for (let k of Object.keys(this.slotTimelines)) {
    ...
    for (let k of Object.keys(this.constraintTimelines)) {
    ...
    for (let k of Object.keys(this.animationTimelines)) {
    ...
    for (let k of Object.keys(this.boneCachedFrameIndices)) {
      delete this.boneCachedFrameIndices[k];
    }

    for (let k of Object.keys(this.slotCachedFrameIndices)) {
