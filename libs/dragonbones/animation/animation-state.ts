...
export class AnimationState extends BaseObject {
  ...
  private _updateBoneAndSlotTimelines(): void {
    { // Update bone and surface timelines.
      const boneTimelines: SMap<Array<TimelineState>> = {};
      ...
      for (let k of Object.keys(boneTimelines)) { // Remove bone timelines.
    ...
    { // Update slot timelines.
      const slotTimelines: SMap<Array<TimelineState>> = {};
      ...
      for (let k of Object.keys(slotTimelines)) { // Remove slot timelines.
