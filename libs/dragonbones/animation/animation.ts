...
import { AnimationState, BlendState } from './animation-state';
...
export class Animation extends BaseObject {
   ...
   * @language zh_CN
   */
  public get animations(): SMap<AnimationData> {
    return this._animations;
  }
  public set animations(value: SMap<AnimationData>) {
  ...
  private readonly _animations: SMap<AnimationData> = {};
  private readonly _blendStates: SMap<SMap<BlendState>> = {};
  ...
  public advanceTime(passedTime: number): void {
    ...
    for (let k of Object.keys(this._blendStates)) {
      const blendStates = this._blendStates[k];
      for (let kB of Object.keys(blendStates)) {
  ...
  public playConfig(animationConfig: AnimationConfig): AnimationState | null {
    ...
    for (let k of Object.keys(animationData.animationTimelines)) { // Blend animation node.
